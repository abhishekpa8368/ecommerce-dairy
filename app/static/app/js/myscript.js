...
$('.plus-cart').click(function(){
    ...
    $.ajax({
        ...
        success:function(data){
            // eml.innerText=eml.innerHTML+data.quantity ;
            document.getElementById("quantity-"+id).innerText=parseInt(document.getElementById("quantity-"+id).innerText)+1;
